            ...
            <div className="container max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="bg-gray-100 rounded-lg shadow-lg overflow-hidden">
                        <img src={`${process.env.PUBLIC_URL}/sig_fish.jpeg`} alt="Signature Grilled Fish" className="w-full h-80 object-cover"/>
                        <div className="p-6">
                    ...
                    <div className="bg-gray-100 rounded-lg shadow-lg overflow-hidden">
                        <img src={`${process.env.PUBLIC_URL}/sig_roasted.jpg`} alt="Roasted Lamb Skewers" className="w-full h-80 object-cover"/>
                        <div className="p-6">
